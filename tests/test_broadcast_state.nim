...
const
  ...
  # Under GV57's typed-pheromone rules, this CTF-mode seed 1 take ends on a
  # capture (Blue captures the red heart, eliminating Red). The recording must ALSO keep
