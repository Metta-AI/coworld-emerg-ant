...
const
  ...
  # CURRENT gameplay rules (GameVersion 49, seed 908, lives 9:
  #   record_fixture.sh tests/replays/ctf.bitreplay 908 10000 \
  #     '{"lives":9,"carrierSpeedPct":1}')
  # The GV49 take kept all three weapons (gun 72 / grenade 2 / spray 12,
  # nine steals and thirteen heals). GV49 also pins carrierSpeedPct=1:
